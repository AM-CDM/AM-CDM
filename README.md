...
Figure 4 - AM-CDM use case linking a PowderStock class object to a Specimen class object. Boxes indicate connections between parent classes and required name/ID properties.
...
Figure 5 - The same use case in Figure 4 represented as text in the SADL files.
